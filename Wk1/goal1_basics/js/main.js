...
console.log('------ strings ----------');
    ...
    var testString = "He's in PWA1"; //double quote errors out
...
console.log('------ numbers ----------');
    //extra long or extra small numbers
    var y = 123e5; //12300000 (with 5 additional decimal places)
    var z = 123e-5; //0.00123   (with 5 subtracted decimal places)
   ...
   // console.log("counter--: ", num);
    ...
    //console.log("--counter: ", num--);//will be 9 because it didn't decrement
    ...
    //modulo example (modulo, returns the remainder of an equation
...
/*
    BREAKING AN ARRAY DOWN TO INDIVIDUAL PIECES
     ...
     - as an example
        var myArr = new myArr[]; //empty array
 ...
 */
    ...
    console.log("index 4: ", myArr[4]); //will output undefined because it doesn't exist
 ...
 ********************************************/
    ...
    console.log("the sum of all numbers ", array[0] + array[1] + array[2] + array[3]);
...
if ("1" === 1){ //doesn't output to the console in the html
 ...
 */
    ...
    if ("a" === "a"){ //change it to a !== and it will turn out false
 ...
 */
    ...
    if ( !(1 === 1) || ("hi" === "no") ){ //! changes it to false
        console.log('|| logical operator: one side = true');
    }else{
 ...
 */
    ...
    var smile = true; //change to false and it will output sad
...
var weather = 'Sunny';
    ...
    console.log("Student Mood: ", student1);
...
var moodType = moodFN(value1, value2); //information is stored within the variable
